...
# {'Evil': 2, 'is': 4, 'done': 1, 'by': 4, 'oneself': 4,
#   'one': 4, 'defiled': 1, 'left': 1, 'undone': 1, 'cleansed': 1,
#     'Purity': 1, 'and': 1, 'impurity': 1, 'are': 1, "one's": 1,
#       'own': 1, 'doing': 1, 'No': 2, 'purifies': 2, 'another': 1, 'other': 1}